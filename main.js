...
global.channelLink = "https://whatsapp.com/channel/0029Vb7lAQs4NViqQM8tBj3M";
global.ytch = "Dev shadow tech";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb7lAQs4NViqQM8tBj3M'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/JPOlauBDBNUG1qpR5T9drR?mode=wwt`
                }, { quoted: message });
                return;
            }
        }
